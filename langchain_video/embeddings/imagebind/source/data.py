...
from langchain_video.embeddings.imagebind.source.models.multimodal_preprocessors import SimpleTokenizer

DEFAULT_AUDIO_FRAME_SHIFT_MS = 10  # in milliseconds


def return_bpe_path():
    package_path = 'langchain_video.embeddings.imagebind'
    resource_path = 'source/bpe/bpe_simple_vocab_16e6.txt.gz'
    
    return resources.files(package_path).joinpath(resource_path)
